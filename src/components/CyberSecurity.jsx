...
const CyberSecurity = () => {
  ...
  return (
    <div>
      <h2 className='course-heading'>Cyber Security</h2>
      <div className="cards" style={{display:'flex' , gap:'3rem' , justifyContent:'center' , padding:'2rem'}}>
      <Card sx={{ maxWidth: 245 }}>
        <CardMedia sx={{ height: 100 }} image={Data1} title="green iguana" />
        <CardContent>
          <Typography gutterBottom variant="h5" component="div">
          Cyber Security
          </Typography>
          <Typography variant="body2" color="text.secondary">
          Cyber Security helps build and maintain both the front-end and the back-end of a website
          </Typography>
        </CardContent>
        <CardActions>
